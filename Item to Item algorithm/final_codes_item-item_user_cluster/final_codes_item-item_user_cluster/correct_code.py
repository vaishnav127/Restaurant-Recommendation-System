attribute_3=read.csv("Vash_FC_6000.csv")#attribute3 wali files
library(varhandle)
new_user_preferences=read.csv("new_users.csv")#preferences of new users data
...
cen=read.csv("user_cluster_centroid.csv")#centroid wali file
...
write.csv(w,"new_users_allocated_clusters.csv",row.names=FALSE)
